const weddingDate = new Date('2026-10-03T11:58:00+08:00')
...
if (publicRsvpUrl) {
  ...
  function updateAccommodation() {
    ...
    if (needed) { rsvpForm.elements.checkInAt.value ||= '2026-10-02T14:00'; rsvpForm.elements.checkOutAt.value ||= '2026-10-03T12:00' }
  }
  function fillRsvp(data) {
    ...
    rsvpForm.elements.checkInAt.value = data.checkInAt || '2026-10-02T14:00'; rsvpForm.elements.checkOutAt.value = data.checkOutAt || '2026-10-03T12:00'; messageCount.value = String(rsvpForm.elements.message.value.length); updateAccommodation()
  }
